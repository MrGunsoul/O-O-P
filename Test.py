...
fennec=Mammal ("4", "fennec", "Finnick", "3x5m", 9000)
...
lista=[kitty.storage, kitty2.storage, mammoth.storage, otter.storage, fennec.storage, bear.storage, tamarin.storage, pallas_cat.storage]
print(sorted(lista, key=itemgetter(4)))